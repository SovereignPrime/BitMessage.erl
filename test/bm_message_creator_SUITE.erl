...
create_getchunk_test(_Config) -> % {{{2
    ...
    Inv = bm_message_creator:create_getchunk(<<159,153,22,221,154,13,194,245,123,40,
                                               ...
                                               15,125,207,166,53,154,96,128,
                                               79,197,107,61,69,44, 
                                               159,153,22,221,154,13,194,245,123,40,
                                               6,18,158,196,236,179,70,190,
                                               15,125,207,166,53,154,96,128,
                                               79,197,107,61,69,44>>,
                                             <<159,153,22,221,154,13,194,245,123,40,
    ...
    ?assert(meck:called(bm_db, 
                        ...
                        [inventory,
                         [#inventory{
                             hash = <<22,110,89,128,40,63,244,236,148,134,180,81,
                                      176,75,29,82,120,183,
                                      171,231,167,155,249,147,89,177,64,215,
                                      44,5,240,198>>, 
                             stream = 1,
                             type = 5,
                             payload = <<0,0,0,0,0,0,8,0,0,0,0,0,85,46,49,77,
                                         0,0,0,5,1,1,159,153,22,221,
                                         154,13,194,245,123,40,6,18,158,196,
                                         236,179,70,190,15,125,207,166,
                                         53,154,96,128,79,197,107,61,69,44,159,
                                         153,22,221,154,13,194,245,
                                         123,40,6,18,158,196,236,179,70,190,15,
                                         125,207,166,53,154,96,128,
                                         79,197,107,61,69,44,159,153,22,221,154,
                                         13,194,245,123,40,6,18,158,
                                         196,236,179,70,190,15,125,207,166,53,154,
                                         96,128,79,197,107,61,69,
                                         44,185,251,167,1,73,222,135,86,207,254,
                                         122,138,45,148,26,58,106,
                                         11,71,247,233,249,158,186,146,93,98,3,143,
                                         232,206,65>>,
                             time='_'
                            }]])).
