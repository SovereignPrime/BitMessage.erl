...
create_getchunk_test(_Config) -> % {{{2
    ...
    ?assert(meck:called(bm_db, 
                        ...
                        [inventory,
                         [#inventory{
                             hash = <<58,193,100,150,188,210,91,131,58,126,
                                      116,105,142,214,39,69,11,104,
                                      168,233,163,24,75,15,144,147,217,47,
                                      252,226,176,6>>, 
                             stream = 1,
                             type = 5,
                             payload = <<0,0,0,0,0,0,8,0,0,0,0,0,85,9,85,93,
                                         0,0,0,5,1,1,159,153,22,221,154,
                                         13,194,245,123,40,6,18,158,196,236,179,
                                         70,190,15,125,207,166,53,
                                         154,96,128,79,197,107,61,69,44,159,
                                         153,22,221,154,13,194,245,123,
                                         40,6,18,158,196,236,179,70,190,15,125,
                                         207,166,53,154,96,128,79,
                                         197,107,61,69,44,159,153,22,221,154,
                                         13,194,245,123,40,6,18,158,
                                         196,236,179,70,190,15,125,207,166,53,
                                         154,96,128,79,197,107,61,69,
                                         44,185,251,167,1,73,222,135,86,207,
                                         254,122,138,45,148,26,58,106,
                                         11,71,247,233,249,158,186,146,93,98,
                                         3,143,232,206,65>>,
                             time='_'
                            }]])).
